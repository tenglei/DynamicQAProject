						...
						<ul class="nav">
							...
							<li ng-class="{active:$state.includes('app.table')}"><a href
								...
								<ul class="nav nav-sub dk">
									...
									<li ui-sref-active="active"><a ui-sref="app.table.static">
							...
							<li ng-class="{active:$state.includes('app.form')}"><a href
								class="auto"> <span class="pull-right text-muted"> <i
									...
									translate="aside.nav.components.form.FORM">我的关注</span>
							</a>
								<ul class="nav nav-sub dk">
									<li class="nav-sub-header"><a href> <span
											translate="aside.nav.components.form.FORM">我的关注</span>
									...
									<li ui-sref-active="active"><a ui-sref="app.form.elements">
											<span translate="aside.nav.components.form.FORM_ELEMENTS">关注的人</span>
									</a></li>
									<li ui-sref-active="active"><a
										ui-sref="app.form.validation"> <span
											translate="aside.nav.components.form.FORM_VALIDATION">关注的主题</span>
									</a></li>
									<li ui-sref-active="active"><a ui-sref="app.form.wizard">
											<span translate="aside.nav.components.form.FORM_WIZARD">关注的问卷</span>
									</a></li>
									<!--                   <li ui-sref-active="active"> -->
									...
									<div class="m-l-xxl panel b-a">
										<div class="panel-heading pos-rlt">
											<span class="arrow left pull-up"></span> <span
												class="text-muted m-l-sm pull-right"> 十分钟之前 </span> <a ><s:property value="welcomename"/></a>添加了<s:property/>问卷 链接：
												<s:property value="linklist[#st.index]"/>
										</div>
									</div>
								</div>
								</s:iterator>
								...
								<ul class="list-group">
									<li class="list-group-item">
										<p>
											...
											class="fa fa-fw fa-clock-o"></i> 两分钟前</small>
									</li>
									<li class="list-group-item">
										<p>
											第二名:BBB
										</p> <small class="block text-muted"><i
											class="fa fa-fw fa-clock-o"></i> 一分钟前</small>
									</li>
									<li class="list-group-item">
										<p>
											第三名：CCC
